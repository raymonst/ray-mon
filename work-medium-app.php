			...
			<div class="container-section">
				...
				<section>
					<div class="container-section-item">
						...
						<figure>
							<img src="_images/work-medium-app-north-star-sketches.jpg" alt="work-medium-app-north-star-sketches" width="1000" height="1041" >
			...
			<div class="container-section">
				...
				<section>
					<div class="container-section-item">
						...
						<figure>
							<img src="_images/work-medium-app-architecture.png" alt="work-medium-app-architecture" width="1560" height="974" >								<figcaption>Simplifying the base app architecture creates a more focused experience.</figcaption>
						</figure>
					</div>
				</section>
			</div>
			...
			<div class="container-section">
				...
				<section>
					<div class="container-section-item">
						...
						<figure>
							<img src="_images/work-medium-app-home.jpg" alt="work-medium-app-home" width="1525" height="1700" >
						...
						<figure class="image-size-s image-alignment-r">
							<img src="_images/work-medium-app-badges.jpg" alt="work-medium-app-badges" width="750" height="648" >														<figcaption>Badges nudge users to read from authors and publications they follow.</figcaption>
						</figure>
				...
				<section>
					<div class="container-section-item">
						...
						<figure class="figure-l">
							<img src="_images/work-medium-app-meter.jpg" alt="work-medium-app-meter" width="1620" height="1561" >
						...
						<figure class="figure-l">
							<img src="_images/work-medium-app-rebrand.jpg" alt="work-medium-app-rebrand" width="1540" height="1076" >
						...
						<figure>
							<img src="_images/work-medium-app-themes.jpg" alt="work-medium-app-themes" width="1542" height="1590" >
						...
						<figure class="figure-l">
							<img src="_images/work-medium-app-design-system.jpg" alt="work-medium-app-design-system" width="2400" height="1720" >							<figcaption>Changes to the design system had to be audited and evaluated globally. Above is an example of how I stress-tested typography changes across product surfaces.</figcaption>
						</figure>
					</div>
				</section>
			</div>
