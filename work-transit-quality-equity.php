	...
	<body class="with-cover">
		...
		<header>
			<div class="title">
				...
				<div class="title-link"><a href="urbandatachallenge/" target="_blank" class="link-cta">view project</a></div>
			</div>
			...
			<div class="container-section">
				...
				<section>
					<div class="container-section-item">
						...
						<br/>
						<figure>
							<img src="_images/work-transit-quality-equity-01.jpg" alt="Project summary" width="1600" height="900">			
							<figcaption>Project summary</figcaption>
						</figure>
						<figure>
							<img src="_images/work-transit-quality-equity-02.jpg" alt="Surfacing transit performance data" width="1600" height="900">
							<figcaption>Surfacing transit performance data</figcaption>
						</figure>
						<figure>
							<img src="_images/work-transit-quality-equity-03.jpg" alt="Adding a layer of economic data as indicators of equity" width="1600" height="900">			
							<figcaption>Adding a layer of economic data as indicators of equity</figcaption>
						</figure>
						<figure>
							<img src="_images/work-transit-quality-equity-04.jpg" alt="Same visualization, different city" width="1600" height="900">										
							<figcaption>Same visualization, different city</figcaption>
						</figure>
						<figure>
							<img src="_images/work-transit-quality-equity-05.jpg" alt="Same visualization, different city (with economic data turned off)" width="1600" height="900">							
							<figcaption>Same visualization, different city (with economic data turned off)</figcaption>
						</figure>
						<figure>
							<img src="_images/work-transit-quality-equity-06.jpg" alt="Investigating the role of data visualization in city planning" width="1000" height="1500">							
							<figcaption>Investigating the role of data visualization in city planning</figcaption>
						</figure>
					</div>
				</section>
			</div>
