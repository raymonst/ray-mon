				...
				<div class="container-section">
					...
					<section>
						...
						<div class="container-section-item">
							...
							<ul class="list-text">
								<li>Teach the basics of information visualization, with emphasis on urban planning applications &amp; contexts</li>
							</ul>
						</div>
						<div class="container-section-item">
							<h3>Guest Lecturer</h3>
							...
							<ul class="list-text">
								<li>Lecture &amp; lead discussion on the topic of design &amp; the workplace</li>
							</ul>
						</div>
					</section>
				</div>
					...
					<section>
						<div class="container-section-item">
							...
							<ul class="list-text">
								...
								<li>Front-End Development (Desktop &amp; Mobile Web)</li>
							</ul>
						</div>
						<div class="container-section-item">
							<h3>Tools</h3>
